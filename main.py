        ...
        try:
            while True:
                ...
                if (
                    ...
                    or self._is_model_audio_suppressed()
                ):
                    self.set_speaking(False)
                ...
                if stream is None:
                    try:
                        device = self._select_output_device(RECEIVE_SAMPLE_RATE, CHANNELS, "int16")
                        ...
                        print(f"[FRIDAY] 🔊 Audio output device: {device}")
                    except Exception as exc:
                        audio_disabled = True
